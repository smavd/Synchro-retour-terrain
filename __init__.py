...
from synchro_retour_terrain-main.window_retour_terrain import WindowRetourTerrain # Vs Code ne trouve pas le module situé dans le même dossier mais Qgis le trouvera bien. 
